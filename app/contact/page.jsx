...
export default function Page() {
    return (
        <div className="py-20">
            ...
            <form 
                action="https://formspree.io/f/mgegjgdj" 
                method="post" 
                className="max-w-md mx-auto grid gap-2 px-6"
            >
                <Label className="mt-3" htmlFor="name">Full Name</Label>
                <Input autocomplete="off" id="name" type="text" name="name" placeholder="John Deo" required />
                <Label className="mt-3" htmlFor="email">Email</Label>
                <Input autocomplete="off" id="email" type="email" name="email" placeholder="john@deo.com" required />
                <Label className="mt-3" htmlFor="message">Message</Label>
                <Textarea className="min-h-[100px]" autocomplete="off" id="message" name="message" placeholder="I wanna hire yo.." required></Textarea>
                <Button className="mt-4" type="submit">Send</Button>
            </form>
        </div>
    );
