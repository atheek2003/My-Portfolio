  ...
  return (
    <main className='mb-20'>
      ...
      <div className="text-center mb-0 mt-7">
        ...
        <p className='text-xs'>Some of my skills i learnt and still learning  in my journey of <br /> self though coding<span className="text-primary">.</span></p>
      </div>
      ...
      <div className="text-center mb-5">
        ...
        <p className='text-xs text-size 1.3 rem'>Some of my projects i built, click view all <br /> for all projects<span className="text-primary">.</span></p>
      </div>
